    ...
    <div id="rev_slider_1" class="rev_slider rev-slider-kidz-school" data-version="5.4.5" style="display:none">
      ...
      <ul>
        ...
        <li data-transition="fade">
          <img src="{{ asset('img/banner/slider-1/img-1.png') }}" alt="Sky" class="rev-slidebg">
          <!-- LAYERS-->
        ...
        <!-- SLIDE 2  -->
        <li data-transition="fade">
          <img src="{{ asset('img/banner/slider-1/img-2.png') }}" alt="Sky" class="rev-slidebg">
          <!-- LAYERS -->
        ...
        <!-- SLIDE 4  -->
        <li data-transition="fade">
          <img src="{{ asset('img/banner/slider-1/img-4.png') }}" alt="Sky" class="rev-slidebg">
          <!-- LAYERS -->
          ...
          <div class="tp-caption tp-resizeme font-dosis font-weight-bold"
            ...
            data-responsive_offset="off"
            style="z-index: 1;">
              <span class="text-white">確かな技術力</span>
          </div>
